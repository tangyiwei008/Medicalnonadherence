...
dfs = [pd.read_csv(f'D:/School 2.0 Data/CAL EL Project BCBS/new_data/weeks_n/test_weeks_{n}..csv', low_memory=False) for n in range(1, 11)]
...
clab_member = pd.read_csv('D:/School 2.0 Data/CAL EL Project BCBS/new_data/clab_member/CLAB_MEMBER_TEST.csv',
                          low_memory=False)
...
for shift in shifts:
    ...
    df_merged.to_csv('ipro_new.csv', index=False)
