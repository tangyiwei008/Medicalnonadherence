...
df_proc = pd.read_csv('rxclaims_full_new.csv',
                      usecols=['PROC_CD'],
                      low_memory=False)
...
del index_change, proc_dict1, proc_dict2
del proc_dict3, proc_dict4, proc_dict5, proc_dict6
...
df.to_csv('rxclaims_recoded_new.csv',
          index=False)
