...
df = df.drop(columns=['currpers_id', 'FINAL_RACE', 'FINAL_RACE_MULTIPLE',
...
categorical_cols = [
    ...
    'USDA_FD_TRACT_LA_20_F', 'USDA_FD_TRACT_LA_VEHICLE_20_F', 'CNTY_NM',
    'IPRO_RISK_LEVEL_FINANCIAL', 'IPRO_RISK_LEVEL_FOOD',
    'IPRO_RISK_LEVEL_HOUSING', 'IPRO_RISK_LEVEL_SOCIAL',
