...
def preprocess_data(filepath, filepath2):
    ...
    off_limits = ['cas_nums_135_', 'cas_nums_163_', 'cas_nums_164_', 'cas_nums_170_', 'cas_nums_171_', 'cas_nums_172_',
                  'cas_nums_173_', 'cas_nums_174_', 'cas_nums_10119_', 'cas_nums_39_', 'cas_nums_49_', 'cas_nums_17_',
                  'cas_nums_23_', 'cas_nums_24_', 'cas_nums_25_', 'cas_nums_26_', 'cas_nums_29_', 'cas_nums_50_',
                  'cas_nums_51_', 'cas_nums_40_', 'cas_nums_41_', 'cas_nums_48_', 'cas_nums_120_',
                  'cas_nums_10133', 'cas_nums_10134']
...
def train_and_evaluate(X, y, X_test, y_test, IDs_test, week_num_adhere_test, i, scoring=weighted_scorer):
    ...
    # predictions_df.to_csv(f'predictions_xgb_full_final_sensitive.csv', index=False)
...
for i, filepath in enumerate(filepaths, start=1):
    ...
    importance_df.to_csv(f'feature_importance_full_final_sensitive.csv', index=False)
