...
def main():
    ...
    model_file = f'xgb_model_final.pkl'
    predictions = load_model_and_predict(model_file, X)
    all_predictions.append(predictions)
    ...
    final_predictions_df.to_csv('new_predictions_final.csv', index=False)
    print("Final predictions saved to 'new_predictions_final.csv'.")
